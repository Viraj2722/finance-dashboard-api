...
async function main() {
    ...
    const analystUser = await prisma.user.upsert({
        ...
        create: {
            ...
            password: await bcryptjs_1.default.hash("analyst123", 10),
            role: "ANALYST",
            status: "ACTIVE",
        },
    });
    const viewerUser = await prisma.user.upsert({
        ...
        create: {
            ...
            password: await bcryptjs_1.default.hash("viewer123", 10),
            role: "VIEWER",
            status: "ACTIVE",
        },
    });
    ...
    for (let i = 0; i < 20; i++) {
        ...
        const category = isIncome || i % 2 === 0
            ? categories[Math.floor(Math.random() * categories.length)]
            : "SALARY"; // SALARY is income, others are expense
        const amount = isIncome || category === "SALARY"
        ...
        records.push({
            ...
            type: (isIncome || category === "SALARY" ? "INCOME" : "EXPENSE"),
            category,
            date: recordDate,
